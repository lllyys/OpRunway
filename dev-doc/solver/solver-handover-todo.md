...
`dev-doc/oprunway-todo.md` 指到本文件。只收录 Mr.0 明示要记的条目。
...
| HT-11 | C3：复数拆实/虚口径——T7 已摘 | ✅ 完成 | Mr.0 裁定 issue 即书面确认 |
...
- **裁定**：Mr.0 2026-09-24——「用新的生态标准 opbase 最新标准，这个决定了」，即 B 方案：
...
- **硬约束**（本文件「Mr.0 补充描述」三条）：不落 npz、流式现场构造现场使用；
...
- **做什么**：发布前用 CPU 参考链路算好写入 index，判定时只读、零重算——
  ...
  - 批量：case 条目存加权均值 Σ(count_j·ratio_j)/batchSize（与任务书「batch 个矩阵
    均值」数学等价，CPU 只算代表）；
  - info 用例与非正定矩阵不计入（Mr.0 2026-09-24 引 issue B2 口径确认）；两类用例
...
- **遗留两条**：任务书侧 6 处 ε 数值修订（2⁻²³→2⁻²⁴）属对外动作待 Mr.0 路由；
...
- **裁定**：Mr.0 2026-09-24——「我们的设计有问题，得先走生态精度标准，不通过的话再走
...
- **做什么**（criteria/cards_cholesky.py 为主）：
  ...
  - **主判基准统一换 golden64**（Mr.0 2026-09-24 裁「用任务书的」，supplement 24h）：
...
- **背景**：`review-bundle-issues-0924.md` B2（Mr.0 2026-09-24 贴文确认）。
- 完成落点：
...
- **背景**：`review-bundle-issues-0924.md` B3（Mr.0 2026-09-24 贴文确认）。
- 完成落点：
...
- **背景**：`review-bundle-issues-0924.md` B4（Mr.0 2026-09-24 贴文确认）。
- 完成落点：
...
- **裁定**：Mr.0 2026-09-24——issue 即书面确认，摘 T7。
...
- **背景**：`review-bundle-issues-0924.md` C4（Mr.0 2026-09-24 贴文）。
- 完成落点：设计维持即完成，无产物。
...
- **裁定**：Mr.0 2026-09-24 选②——**维持 A64**，不随 potrs 条款类推；待任务侧对
...
- **当前动作**：零代码改动（暂维持裁定已记 supplement 24i）；**未闭环**——
  ① 补字请求随任务书反馈清单路由（待 Mr.0 发）；② 任务侧补字后按其口径复核，
