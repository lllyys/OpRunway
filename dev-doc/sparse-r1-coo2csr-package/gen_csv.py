...
FACTS = {
    ...
    # csv_loader 缺列回退 0.0 与存量取值一致；阈值列值源未建，本版要求覆盖为空表。
    ...
    "golden": {"kind": "harness"},
    # no_static_check 下引擎不做静态显存估算，规模上界由作者在网格里自行封顶：
    # harness 的 targetNnz = int(m*n*(1-sparsity)) 是 int，本表全部组合
    # nnz ≤ 2^24（cooRowInd ≈ 64 MiB），大 m 桶只配小 n，防 int 溢出与 OOM。
    "case_controls": [
    ...
    "perf": {
      ...
      {"m": 16383, "n": "16", "sparsity": "0.9"},
      {"m": 16383, "n": "16", "sparsity": "0.995"},
      {"m": 16383, "n": "256", "sparsity": "0.0"},
      ...
      {"m": 16384, "n": "16", "sparsity": "0.9"},
      {"m": 16384, "n": "16", "sparsity": "0.995"},
      {"m": 16384, "n": "256", "sparsity": "0.0"},
      ...
      {"m": 16385, "n": "16", "sparsity": "0.9"},
      {"m": 16385, "n": "16", "sparsity": "0.995"},
      {"m": 16385, "n": "256", "sparsity": "0.0"},
      ...
      {"m": 65535, "n": "16", "sparsity": "0.9"},
      {"m": 65535, "n": "16", "sparsity": "0.995"},
      {"m": 65535, "n": "256", "sparsity": "0.0"},
      ...
      {"m": 65536, "n": "16", "sparsity": "0.9"},
      {"m": 65536, "n": "16", "sparsity": "0.995"},
      {"m": 65536, "n": "256", "sparsity": "0.0"},
      {"m": 65536, "n": "256", "sparsity": "0.5"},
      {"m": 65536, "n": "256", "sparsity": "0.9"},
      {"m": 65536, "n": "256", "sparsity": "0.995"},
      {"m": 262144, "n": "1", "sparsity": "0.0"},
      {"m": 262144, "n": "1", "sparsity": "0.5"},
      {"m": 262144, "n": "1", "sparsity": "0.9"},
      {"m": 262144, "n": "1", "sparsity": "0.995"},
      {"m": 262144, "n": "16", "sparsity": "0.0"},
      {"m": 262144, "n": "16", "sparsity": "0.5"},
      {"m": 262144, "n": "16", "sparsity": "0.9"},
      {"m": 262144, "n": "16", "sparsity": "0.995"},
      {"m": 1048576, "n": "1", "sparsity": "0.0"},
      {"m": 1048576, "n": "1", "sparsity": "0.5"},
      {"m": 1048576, "n": "1", "sparsity": "0.9"},
      {"m": 1048576, "n": "1", "sparsity": "0.995"},
      {"m": 1048576, "n": "16", "sparsity": "0.0"},
      {"m": 1048576, "n": "16", "sparsity": "0.5"},
      {"m": 1048576, "n": "16", "sparsity": "0.9"},
      {"m": 1048576, "n": "16", "sparsity": "0.995"},
        ],
        "meta": {
    ...
    "sources": {
        ...
        "perf": "无 GPU 对标（R1 预期 NO_REF），m 阶梯 2^k±1 加大值，nnz 上界见 case_controls 注",
    },
}
# ===== FACTS 区结束 =====
