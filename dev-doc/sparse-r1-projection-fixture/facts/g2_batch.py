...
FACTS = {'schema_version': 1,
 ...
 'params': [{'name': 'handle', 'ctype': 'aclblasHandle_t', 'role': 'handle'},
            ...
            {'name': 'batchCount', 'ctype': 'int', 'role': 'dim'},
            {'name': 'A',
             'ctype': 'const float*',
             'role': 'matrix',
             'dtype': 'float32',
             ...
             'cols': 'n',
             'ld': 'lda',
             'batch': {'model': 'strided', 'count': 'batchCount', 'stride': 'strideA'}},
            {'name': 'lda', 'ctype': 'int', 'role': 'layout', 'kind': 'ld', 'of': 'A'},
            {'name': 'strideA', 'ctype': 'int', 'role': 'layout', 'kind': 'stride', 'of': 'A'},
            {'name': 'B',
             'ctype': 'const float* const*',
             'role': 'matrix',
             'dtype': 'float32',
             'dir': 'in',
             'rows': 'm',
             'cols': 'n',
             'ld': 'ldb',
             'batch': {'model': 'ptr_array',
                       'count': 'bcB',
                       'table_mem': 'host',
                       'element_mem': 'device'}},
            {'name': 'ldb', 'ctype': 'int', 'role': 'layout', 'kind': 'ld', 'of': 'B'},
            {'name': 'bcB', 'ctype': 'int', 'role': 'layout', 'kind': 'batch', 'of': 'B'},
            {'name': 'C',
             'ctype': 'float*',
             'role': 'matrix',
             'dtype': 'float32',
             ...
             'cols': 'n',
             'ld': 'ldc',
             'batch': {'model': 'contiguous_implicit', 'count': 'bcC'}},
            {'name': 'ldc', 'ctype': 'int', 'role': 'layout', 'kind': 'ld', 'of': 'C'},
            {'name': 'bcC', 'ctype': 'int', 'role': 'layout', 'kind': 'batch'}],
 'constraints': ['m >= 1', 'n >= 1', 'batchCount >= 1'],
 'golden': {'kind': 'cblas', 'symbol': 'cblas_sgemm'},
 'verify': ['batch_each', 'full'],
 'edge_cases': [{'name': 'uniform_a',
                 'set': {'A_batch_pattern': 'UNIFORM'},
                 'expect': 'ACLBLAS_STATUS_SUCCESS',
                 'source': '合成 fixture：batch pattern 控制列（UNIFORM）'},
                {'name': 'null_element_b',
                 'set': {'B_batch_pattern': 'NULL_ELEMENT_3'},
                 'expect': 'ACLBLAS_STATUS_INVALID_VALUE',
                 'source': '合成 fixture：batch pattern 控制列（NULL_ELEMENT_i）'}],
 'cases': {'dim_tiers': [2, 4, 8], 'batch_tiers': [1, 3], 'max_footprint_bytes': 268435456},
 'sources': {'params': '合成 fixture：sparse-r1-projection-matrix.md §D 组2（batch 组）'}}
# ===== FACTS 区结束 =====
