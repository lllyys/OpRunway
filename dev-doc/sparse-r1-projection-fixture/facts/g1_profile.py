...
FACTS = {'schema_version': 1,
 ...
 'params': [{'name': 'handle', 'ctype': 'aclblasHandle_t', 'role': 'handle'},
            {'name': 'dtypeA',
             ...
             'values': ['FP16', 'FP32']},
            {'name': 'computeType',
             'ctype': 'aclblasComputeType_t',
             'role': 'enum',
             'enum_kind': 'compute',
             'values': ['COMPUTE_16F', 'COMPUTE_32F']},
            {'name': 'algo',
             'ctype': 'aclblasGemmAlgo_t',
             'role': 'enum',
             'enum_kind': 'algo',
             'values': ['DEFAULT', 'SPLITK']},
            {'name': 'm', 'ctype': 'int', 'role': 'dim'},
            {'name': 'n', 'ctype': 'int', 'role': 'dim'},
            {'name': 'alpha',
             'ctype': 'const void*',
             'role': 'scalar',
             'dtype_from': 'computeType',
             'mem': 'device'},
            {'name': 'A',
             'ctype': 'const void*',
             'role': 'matrix',
 ...
 'constraints': ['m >= 1', 'n >= 1'],
 'golden': {'kind': 'cblas', 'symbol': 'cblas_sgemm'},
 'verify': ['full'],
 'dtype_profiles': [{'name': 'fp32c',
                     'assign': {'dtypeA': 'FP32', 'computeType': 'COMPUTE_32F'},
                     'scalar_dtype': 'complex64',
                     'golden_dtype': 'float32',
                     'precision_row': 'FLOAT32'},
                    {'name': 'fp16r',
                     'assign': {'dtypeA': 'FP16', 'computeType': 'COMPUTE_16F'},
                     'scalar_dtype': 'float32',
                     'golden_dtype': 'float32',
                     'precision_row': 'FLOAT16'}],
 'perf': {'key': ['profile', 'm', 'n'],
          'sweep': True,
          'threshold': 0.9,
          'rows': [{'profile': 'fp32c', 'm': 8, 'n': 8, 'gpu_ms': 0.101},
                   {'profile': 'fp32c', 'm': 16, 'n': 16, 'gpu_ms': 0.203},
                   {'profile': 'fp32c', 'm': 24, 'n': 24, 'gpu_ms': 0.152},
                   {'profile': 'fp32c', 'm': 32, 'n': 32, 'gpu_ms': 0.305},
                   {'profile': 'fp32c', 'm': 40, 'n': 40},
                   {'profile': 'fp32c', 'm': 48, 'n': 48},
                   {'profile': 'fp32c', 'm': 56, 'n': 56},
                   {'profile': 'fp32c', 'm': 64, 'n': 64},
                   {'profile': 'fp32c', 'm': 72, 'n': 72},
                   {'profile': 'fp32c', 'm': 80, 'n': 80},
                   {'profile': 'fp32c', 'm': 88, 'n': 88},
                   {'profile': 'fp32c', 'm': 96, 'n': 96},
                   {'profile': 'fp32c', 'm': 104, 'n': 104},
                   {'profile': 'fp32c', 'm': 112, 'n': 112},
                   {'profile': 'fp32c', 'm': 120, 'n': 120},
                   {'profile': 'fp32c', 'm': 128, 'n': 128},
                   {'profile': 'fp32c', 'm': 136, 'n': 136},
                   {'profile': 'fp32c', 'm': 144, 'n': 144},
                   {'profile': 'fp32c', 'm': 152, 'n': 152},
                   {'profile': 'fp32c', 'm': 160, 'n': 160},
                   {'profile': 'fp32c', 'm': 168, 'n': 168},
                   {'profile': 'fp32c', 'm': 176, 'n': 176},
                   {'profile': 'fp32c', 'm': 184, 'n': 184},
                   {'profile': 'fp32c', 'm': 192, 'n': 192},
                   {'profile': 'fp32c', 'm': 200, 'n': 200},
                   {'profile': 'fp32c', 'm': 208, 'n': 208},
                   {'profile': 'fp32c', 'm': 216, 'n': 216},
                   {'profile': 'fp32c', 'm': 224, 'n': 224},
                   {'profile': 'fp32c', 'm': 232, 'n': 232},
                   {'profile': 'fp32c', 'm': 240, 'n': 240},
                   {'profile': 'fp32c', 'm': 248, 'n': 248},
                   {'profile': 'fp32c', 'm': 256, 'n': 256},
                   {'profile': 'fp32c', 'm': 264, 'n': 264},
                   {'profile': 'fp32c', 'm': 272, 'n': 272},
                   {'profile': 'fp32c', 'm': 280, 'n': 280},
                   {'profile': 'fp32c', 'm': 288, 'n': 288},
                   {'profile': 'fp32c', 'm': 296, 'n': 296},
                   {'profile': 'fp32c', 'm': 304, 'n': 304},
                   {'profile': 'fp32c', 'm': 312, 'n': 312},
                   {'profile': 'fp32c', 'm': 320, 'n': 320},
                   {'profile': 'fp32c', 'm': 328, 'n': 328},
                   {'profile': 'fp32c', 'm': 336, 'n': 336},
                   {'profile': 'fp32c', 'm': 344, 'n': 344},
                   {'profile': 'fp32c', 'm': 352, 'n': 352},
                   {'profile': 'fp32c', 'm': 360, 'n': 360},
                   {'profile': 'fp32c', 'm': 368, 'n': 368},
                   {'profile': 'fp32c', 'm': 376, 'n': 376},
                   {'profile': 'fp32c', 'm': 384, 'n': 384},
                   {'profile': 'fp32c', 'm': 392, 'n': 392},
                   {'profile': 'fp32c', 'm': 400, 'n': 400},
                   {'profile': 'fp32c', 'm': 408, 'n': 408},
                   {'profile': 'fp32c', 'm': 416, 'n': 416},
                   {'profile': 'fp32c', 'm': 424, 'n': 424},
                   {'profile': 'fp32c', 'm': 432, 'n': 432},
                   {'profile': 'fp32c', 'm': 440, 'n': 440},
                   {'profile': 'fp32c', 'm': 448, 'n': 448},
                   {'profile': 'fp32c', 'm': 456, 'n': 456},
                   {'profile': 'fp32c', 'm': 464, 'n': 464},
                   {'profile': 'fp32c', 'm': 472, 'n': 472},
                   {'profile': 'fp32c', 'm': 480, 'n': 480},
                   {'profile': 'fp32c', 'm': 488, 'n': 488},
                   {'profile': 'fp32c', 'm': 496, 'n': 496},
                   {'profile': 'fp32c', 'm': 504, 'n': 504},
                   {'profile': 'fp32c', 'm': 512, 'n': 512},
                   {'profile': 'fp32c', 'm': 520, 'n': 520},
                   {'profile': 'fp32c', 'm': 528, 'n': 528},
                   {'profile': 'fp32c', 'm': 536, 'n': 536},
                   {'profile': 'fp32c', 'm': 544, 'n': 544},
                   {'profile': 'fp32c', 'm': 552, 'n': 552},
                   {'profile': 'fp32c', 'm': 560, 'n': 560},
                   {'profile': 'fp32c', 'm': 568, 'n': 568},
                   {'profile': 'fp32c', 'm': 576, 'n': 576},
                   {'profile': 'fp32c', 'm': 584, 'n': 584},
                   {'profile': 'fp32c', 'm': 592, 'n': 592},
                   {'profile': 'fp32c', 'm': 600, 'n': 600},
                   {'profile': 'fp32c', 'm': 608, 'n': 608},
                   {'profile': 'fp32c', 'm': 616, 'n': 616},
                   {'profile': 'fp32c', 'm': 624, 'n': 624},
                   {'profile': 'fp32c', 'm': 632, 'n': 632},
                   {'profile': 'fp32c', 'm': 640, 'n': 640},
                   {'profile': 'fp32c', 'm': 648, 'n': 648},
                   {'profile': 'fp32c', 'm': 656, 'n': 656},
                   {'profile': 'fp32c', 'm': 664, 'n': 664},
                   {'profile': 'fp32c', 'm': 672, 'n': 672},
                   {'profile': 'fp32c', 'm': 680, 'n': 680},
                   {'profile': 'fp32c', 'm': 688, 'n': 688},
                   {'profile': 'fp32c', 'm': 696, 'n': 696},
                   {'profile': 'fp32c', 'm': 704, 'n': 704},
                   {'profile': 'fp32c', 'm': 712, 'n': 712},
                   {'profile': 'fp32c', 'm': 720, 'n': 720},
                   {'profile': 'fp32c', 'm': 728, 'n': 728},
                   {'profile': 'fp32c', 'm': 736, 'n': 736},
                   {'profile': 'fp32c', 'm': 744, 'n': 744},
                   {'profile': 'fp32c', 'm': 752, 'n': 752},
                   {'profile': 'fp32c', 'm': 760, 'n': 760},
                   {'profile': 'fp32c', 'm': 768, 'n': 768},
                   {'profile': 'fp32c', 'm': 776, 'n': 776},
                   {'profile': 'fp32c', 'm': 784, 'n': 784},
                   {'profile': 'fp32c', 'm': 792, 'n': 792},
                   {'profile': 'fp32c', 'm': 800, 'n': 800},
                   {'profile': 'fp16r', 'm': 8, 'n': 8},
                   {'profile': 'fp16r', 'm': 16, 'n': 16},
                   {'profile': 'fp16r', 'm': 24, 'n': 24},
                   {'profile': 'fp16r', 'm': 32, 'n': 32},
                   {'profile': 'fp16r', 'm': 40, 'n': 40},
                   {'profile': 'fp16r', 'm': 48, 'n': 48},
                   {'profile': 'fp16r', 'm': 56, 'n': 56},
                   {'profile': 'fp16r', 'm': 64, 'n': 64},
                   {'profile': 'fp16r', 'm': 72, 'n': 72},
                   {'profile': 'fp16r', 'm': 80, 'n': 80},
                   {'profile': 'fp16r', 'm': 88, 'n': 88},
                   {'profile': 'fp16r', 'm': 96, 'n': 96},
                   {'profile': 'fp16r', 'm': 104, 'n': 104},
                   {'profile': 'fp16r', 'm': 112, 'n': 112},
                   {'profile': 'fp16r', 'm': 120, 'n': 120},
                   {'profile': 'fp16r', 'm': 128, 'n': 128},
                   {'profile': 'fp16r', 'm': 136, 'n': 136},
                   {'profile': 'fp16r', 'm': 144, 'n': 144},
                   {'profile': 'fp16r', 'm': 152, 'n': 152},
                   {'profile': 'fp16r', 'm': 160, 'n': 160},
                   {'profile': 'fp16r', 'm': 168, 'n': 168},
                   {'profile': 'fp16r', 'm': 176, 'n': 176},
                   {'profile': 'fp16r', 'm': 184, 'n': 184},
                   {'profile': 'fp16r', 'm': 192, 'n': 192},
                   {'profile': 'fp16r', 'm': 200, 'n': 200},
                   {'profile': 'fp16r', 'm': 208, 'n': 208},
                   {'profile': 'fp16r', 'm': 216, 'n': 216},
                   {'profile': 'fp16r', 'm': 224, 'n': 224},
                   {'profile': 'fp16r', 'm': 232, 'n': 232},
                   {'profile': 'fp16r', 'm': 240, 'n': 240},
                   {'profile': 'fp16r', 'm': 248, 'n': 248},
                   {'profile': 'fp16r', 'm': 256, 'n': 256},
                   {'profile': 'fp16r', 'm': 264, 'n': 264},
                   {'profile': 'fp16r', 'm': 272, 'n': 272},
                   {'profile': 'fp16r', 'm': 280, 'n': 280},
                   {'profile': 'fp16r', 'm': 288, 'n': 288},
                   {'profile': 'fp16r', 'm': 296, 'n': 296},
                   {'profile': 'fp16r', 'm': 304, 'n': 304},
                   {'profile': 'fp16r', 'm': 312, 'n': 312},
                   {'profile': 'fp16r', 'm': 320, 'n': 320},
                   {'profile': 'fp16r', 'm': 328, 'n': 328},
                   {'profile': 'fp16r', 'm': 336, 'n': 336},
                   {'profile': 'fp16r', 'm': 344, 'n': 344},
                   {'profile': 'fp16r', 'm': 352, 'n': 352},
                   {'profile': 'fp16r', 'm': 360, 'n': 360},
                   {'profile': 'fp16r', 'm': 368, 'n': 368},
                   {'profile': 'fp16r', 'm': 376, 'n': 376},
                   {'profile': 'fp16r', 'm': 384, 'n': 384},
                   {'profile': 'fp16r', 'm': 392, 'n': 392},
                   {'profile': 'fp16r', 'm': 400, 'n': 400},
                   {'profile': 'fp16r', 'm': 408, 'n': 408},
                   {'profile': 'fp16r', 'm': 416, 'n': 416},
                   {'profile': 'fp16r', 'm': 424, 'n': 424},
                   {'profile': 'fp16r', 'm': 432, 'n': 432},
                   {'profile': 'fp16r', 'm': 440, 'n': 440},
                   {'profile': 'fp16r', 'm': 448, 'n': 448},
                   {'profile': 'fp16r', 'm': 456, 'n': 456},
                   {'profile': 'fp16r', 'm': 464, 'n': 464},
                   {'profile': 'fp16r', 'm': 472, 'n': 472},
                   {'profile': 'fp16r', 'm': 480, 'n': 480},
                   {'profile': 'fp16r', 'm': 488, 'n': 488},
                   {'profile': 'fp16r', 'm': 496, 'n': 496},
                   {'profile': 'fp16r', 'm': 504, 'n': 504},
                   {'profile': 'fp16r', 'm': 512, 'n': 512},
                   {'profile': 'fp16r', 'm': 520, 'n': 520},
                   {'profile': 'fp16r', 'm': 528, 'n': 528},
                   {'profile': 'fp16r', 'm': 536, 'n': 536},
                   {'profile': 'fp16r', 'm': 544, 'n': 544},
                   {'profile': 'fp16r', 'm': 552, 'n': 552},
                   {'profile': 'fp16r', 'm': 560, 'n': 560},
                   {'profile': 'fp16r', 'm': 568, 'n': 568},
                   {'profile': 'fp16r', 'm': 576, 'n': 576},
                   {'profile': 'fp16r', 'm': 584, 'n': 584},
                   {'profile': 'fp16r', 'm': 592, 'n': 592},
                   {'profile': 'fp16r', 'm': 600, 'n': 600},
                   {'profile': 'fp16r', 'm': 608, 'n': 608},
                   {'profile': 'fp16r', 'm': 616, 'n': 616},
                   {'profile': 'fp16r', 'm': 624, 'n': 624},
                   {'profile': 'fp16r', 'm': 632, 'n': 632},
                   {'profile': 'fp16r', 'm': 640, 'n': 640},
                   {'profile': 'fp16r', 'm': 648, 'n': 648},
                   {'profile': 'fp16r', 'm': 656, 'n': 656},
                   {'profile': 'fp16r', 'm': 664, 'n': 664},
                   {'profile': 'fp16r', 'm': 672, 'n': 672},
                   {'profile': 'fp16r', 'm': 680, 'n': 680},
                   {'profile': 'fp16r', 'm': 688, 'n': 688},
                   {'profile': 'fp16r', 'm': 696, 'n': 696},
                   {'profile': 'fp16r', 'm': 704, 'n': 704},
                   {'profile': 'fp16r', 'm': 712, 'n': 712},
                   {'profile': 'fp16r', 'm': 720, 'n': 720},
                   {'profile': 'fp16r', 'm': 728, 'n': 728},
                   {'profile': 'fp16r', 'm': 736, 'n': 736},
                   {'profile': 'fp16r', 'm': 744, 'n': 744},
                   {'profile': 'fp16r', 'm': 752, 'n': 752},
                   {'profile': 'fp16r', 'm': 760, 'n': 760},
                   {'profile': 'fp16r', 'm': 768, 'n': 768},
                   {'profile': 'fp16r', 'm': 776, 'n': 776},
                   {'profile': 'fp16r', 'm': 784, 'n': 784},
                   {'profile': 'fp16r', 'm': 792, 'n': 792},
                   {'profile': 'fp16r', 'm': 800, 'n': 800}],
          'meta': {'source': 'synthetic fixture：200 点位沿 (profile, m=n=8k) 铺开'}},
 'sources': {'params': '合成 fixture：sparse-r1-projection-matrix.md §D 组1（profile 组）',
             'perf': '合成 fixture：profile 虚拟键 + sweep + threshold 覆盖'}}
# ===== FACTS 区结束 =====
