...
FACTS = {'schema_version': 1,
 ...
 'params': [{'name': 'handle', 'ctype': 'aclblasHandle_t', 'role': 'handle'},
            ...
            {'name': 'M',
             ...
             'cols': 'n',
             'ld': 'ldshared',
             'conditioning': ['WELL_COND', 'ILL_COND']},
            {'name': 'R',
             'ctype': 'const float*',
             'role': 'matrix',
             'dtype': 'float32',
             ...
             'cols': 'n',
             'ld': 'ldshared',
             'producer': 'lapacke_spotrf(M)'},
            {'name': 'ldshared', 'ctype': 'int', 'role': 'layout', 'kind': 'ld', 'of': ['M', 'R']},
            {'name': 'P',
             'ctype': 'const float*',
             'role': 'matrix',
             'dtype': 'float32',
            ...
            {'name': 'v',
             ...
             'len': 'n',
             'inc': 'incv'},
            {'name': 'incv', 'ctype': 'int', 'role': 'layout', 'kind': 'inc', 'of': 'v'}],
 'constraints': ['m >= 1', 'n >= 1'],
 'golden': {'kind': 'composed', 'formula': 'v = diag(M) + packdiag(P)'},
 'verify': ['full'],
 'sources': {'params': '合成 fixture：sparse-r1-projection-matrix.md §D '
                       '组4（conditioning/packed/producer 组）'}}
# ===== FACTS 区结束 =====
