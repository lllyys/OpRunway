...
FACTS = {
    ...
    "status_vocab": ["NOT_SUPPORTED"],
    "params": [
        {"name": "handle", "ctype": "aclsparseHandle_t", "role": "handle"},
        {"name": "src", "ctype": "const int *", "role": "int_array",
         "dtype": "int32", "dir": "in", "len": "k", "projection": "none"},
        {"name": "k", "ctype": "int", "role": "dim", "projection": "none"},
        {"name": "m", "ctype": "int", "role": "dim"},
        {"name": "dst", "ctype": "int *", "role": "int_array",
         "dtype": "int32", "dir": "out", "len": "m + 1"},
    ],
    "constraints": ["m >= 1"],
    "golden": {"kind": "harness"},
    "case_controls": [
        {"name": "cols", "kind": "tier", "values": ["1", "4"]},
        {"name": "mode", "kind": "enum", "values": ["a", "b"]},
    ],
    "cases": {"vec_dim_tiers": [1, 2, 4]},
    "sources": {"params": "g7 合成用例（v2 检查钉板）"},
}
# ===== FACTS 区结束 =====
