...
FACTS = {'schema_version': 1,
 ...
 'params': [{'name': 'handle', 'ctype': 'aclblasHandle_t', 'role': 'handle'},
            ...
            {'name': 'x',
             ...
             'inc': 1}],
 'constraints': ['n >= 1'],
 'golden': {'kind': 'cblas', 'symbol': 'cblas_sscal'},
 'verify': ['full'],
 'edge_cases': [{'name': 'set_fill',
                 'set': {'x_fill': 'VALUE_NORM_0'},
                 'expect': 'ACLBLAS_STATUS_SUCCESS',
                 'source': '合成负例：蓝图 §C 陷阱5——edge set 写派生列 x_fill，校验拒、生成器其实接受'}],
 'sources': {'params': '合成负例：蓝图 §C 陷阱5——edge_cases.set 的 x_fill 键'}}
# ===== FACTS 区结束 =====
