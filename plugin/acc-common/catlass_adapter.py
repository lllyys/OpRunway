...
# 注：matmul caseset **有意**由本 builder 产、不进 gen_cases 的 golden 加载器路径——那是 elementwise 引擎
# （按算子加载 golden_fn(inputs, attrs)、plan=dtype×shape/broadcast/attr_matrix），与 matmul 的 (m,n,k) plan + A[m,k]/B[k,n]
