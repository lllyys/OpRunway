...
- spec：[`sign.spec.json`](./sign.spec.json) → `../../../acc-common/specs/sign.spec.json`
- runner：[`oprunway_sign_runner.cpp`](./oprunway_sign_runner.cpp) → `../../../acc-common/new_example/oprunway_sign_runner.cpp`
