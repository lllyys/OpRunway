...
from _paths import SKILL_ROOT, SCRIPTS, add_tests_to_path
...
from _decl_fixture import (make_bundle, read_json, seal_bundle,  # noqa: E402
                           write_json)
...
class CheckBundleTest(unittest.TestCase):
    def setUp(self):
        ...
        sealed = seal_bundle(self.original)
