...
| 行 | 段落 | 用在哪一步 |
|---:|---|---|
| 17 | ATK 环境检查与降级方案 | 步骤 6 |
| 46 | 1. 最小目录 | 步骤 3 |
| 60 | 2. 顶层 YAML 最小字段 | 步骤 3 |
| 112 | 3. `inputs` 最小可靠写法 | 步骤 3 |
| 139 | 4. 最关键的 YAML 细节 | 步骤 3 |
| 189 | 5. `attr` / `attrs` / `attr_tuple` | 步骤 3 |
| 219 | 6. 约束生成器最小接口 | 步骤 5（generator） |
| 259 | 7. 执行器最小接口 | 步骤 5（execution plugin） |
| 338 | 8. pyaclnn 最小接口 | 步骤 5（execution plugin） |
| 399 | 9. 最小命令 | 步骤 8 |
| 473 | 10. `atk case` 输出位置 | 步骤 8 |
| 493 | 11. 最常见的 7 个坑 | 排错，任意步骤 |
| 533 | 12. NPU/pyaclnn 真机执行前最少检查项 | 步骤 6、步骤 8 之前 |
| 559 | 13. `sitecustomize.py` 什么时候需要 | 步骤 6 |
| 590 | 14. 最小工作顺序 | 通读一次即可 |
| 603 | 15. 报告输出解读 | 步骤 9、步骤 10 |
